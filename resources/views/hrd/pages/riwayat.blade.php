{{-- resources/views/hrd/pages/riwayat.blade.php --}}
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="px-5 py-3.5 border-b border-gray-100 bg-gray-50/50">
                <form method="GET" action="{{ route('hrd.riwayat.index') }}" class="flex flex-wrap gap-2 items-center">
                    ...
                    @if (request('search') || request('jenis') || request('bulan') || request('tahun'))
                        <a href="{{ route('hrd.riwayat.index') }}"
