    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="px-5 py-3.5 border-b border-gray-100 bg-gray-50/50">
                <form method="GET" action="{{ route('hod.clearance.index') }}" class="flex flex-wrap gap-2 items-center">
                    ...
                    <thead>
                        <tr class="border-b border-gray-100">
                            @foreach (['No', 'Karyawan', 'Aset', 'Jenis Clearance', 'Progres', 'Tanggal Pengajuan', 'Status'] as $th)
                                <th
                                    class="text-left px-5 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wide">
                                    {{ $th }}
                                </th>
                            @endforeach
                            <th
                                class="text-right px-5 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wide">
                                Aksi
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        @forelse ($clearances as $cl)
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors align-top">
                                ...
                                {{-- TGL Pengajuan --}}
                                <td class="px-5 py-4">
                                    {{ $cl->created_at->format('d M Y, H.s') }}
                                </td>
    ...
    <script>
        ...
        function confirmApprove(id, name) {
            Swal.fire({
                ...
                form.action = `{{ url('hod/clearance/aset') }}/${id}/approve`;
                form.submit();
            });
        }
        ...
        function confirmReject(id, name) {
            Swal.fire({
                ...
                form.action = `{{ url('hod/clearance/aset') }}/${id}/reject`;
                form.submit();
            });
        }
    </script>
